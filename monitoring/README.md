...
- **Gateway URL**: https://prometheus.localhost
- **Direct local URL**: http://localhost:9090
...
- **Gateway URL**: https://grafana.localhost
- **Direct local URL**: http://localhost:3003
...
2. Access Grafana at https://grafana.localhost
...
3. **Security**: Protect and rotate the generated Grafana admin password
...
|----------|-------------|---------|
| `GRAFANA_ADMIN_USER` | Grafana admin username | Required; generated by `start.sh` |
| `GRAFANA_ADMIN_PASSWORD` | Grafana admin password | Required; generated by `start.sh` |
