...
const CONTROLS_API_URL = import.meta.env.VITE_CONTROLS_API_URL || API_URL || '';
...
export const controlsApi = {
  ...
  get: (id: string): Promise<AxiosResponse<Control>> => api.get(`/api/controls/${id}`),
  ...
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/controls/${id}`),
  getCategories: (): Promise<AxiosResponse<string[]>> => api.get('/api/controls/categories'),
  getTags: (): Promise<AxiosResponse<string[]>> => api.get('/api/controls/tags'),
  // Bulk upload endpoints
  bulkUpload: (
    data: BulkControlUploadData
  ): Promise<AxiosResponse<{ created: number; updated: number; skipped: number }>> =>
...
export const implementationsApi = {
  list: (
    params?: PaginationParams & { controlId?: string; status?: string }
  ): Promise<AxiosResponse<ControlImplementation[]>> => api.get('/api/implementations', { params }),
  get: (id: string): Promise<AxiosResponse<ControlImplementation>> =>
    api.get(`/api/implementations/${id}`),
  update: (
    id: string,
    data: UpdateImplementationData
  ): Promise<AxiosResponse<ControlImplementation>> => api.put(`/api/implementations/${id}`, data),
  bulkUpdate: (data: {
    ids: string[];
    updates: UpdateImplementationData;
  ...
  getTests: (
    ...
    AxiosResponse<Array<{ id: string; testType: string; result: string; testedAt: string }>>
...
export const collectorsApi = {
  ...
  get: (controlId: string, implementationId: string, collectorId: string) =>
    api.get(
      `/api/controls/${controlId}/implementations/${implementationId}/collectors/${collectorId}`
    ),
  ...
  test: (
    ...
    api.post(
      `/api/controls/${controlId}/implementations/${implementationId}/collectors/${collectorId}/test`,
      data || {}
    ),
  run: (controlId: string, implementationId: string, collectorId: string) =>
    api.post(
      `/api/controls/${controlId}/implementations/${implementationId}/collectors/${collectorId}/run`
    ),
  getRuns: (controlId: string, implementationId: string, collectorId: string, limit?: number) =>
    api.get(
      `/api/controls/${controlId}/implementations/${implementationId}/collectors/${collectorId}/runs`,
      { params: { limit } }
    ),
};
...
export const evidenceApi = {
  ...
  get: (id: string): Promise<AxiosResponse<Evidence>> => api.get(`/api/evidence/${id}`),
  upload: async (file: File, data: UploadEvidenceData): Promise<{ data: Evidence }> => {
  ...
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/evidence/${id}`),
...
export const frameworksApi = {
  list: (): Promise<AxiosResponse<Framework[]>> => api.get('/api/frameworks'),
  get: (id: string): Promise<AxiosResponse<Framework>> => api.get(`/api/frameworks/${id}`),
  ...
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/frameworks/${id}`),
  getRequirements: (
    id: string,
    parentId?: string
  ): Promise<AxiosResponse<FrameworkRequirement[]>> =>
  ...
  seed: (): Promise<AxiosResponse<{ message: string }>> => api.post('/api/frameworks/seed'),
};

export const usersApi = {
  list: (params?: UserListParams): Promise<AxiosResponse<{ data: User[]; total: number }>> =>
    api.get('/api/users', { params }),
  get: (id: string): Promise<AxiosResponse<User>> => api.get(`/api/users/${id}`),
  ...
  create: (data: CreateUserData): Promise<AxiosResponse<User>> => api.post('/api/users', data),
  update: (id: string, data: UpdateUserData): Promise<AxiosResponse<User>> =>
    api.put(`/api/users/${id}`, data),
  deactivate: (id: string): Promise<AxiosResponse<User>> => api.post(`/api/users/${id}/deactivate`),
  reactivate: (id: string): Promise<AxiosResponse<User>> => api.post(`/api/users/${id}/reactivate`),
  ...
  sync: (data: {
    ...
    lastName?: string;
    roles?: string[];
  }): Promise<AxiosResponse<User>> => api.post('/api/users/sync', data),
};
...
export const permissionsApi = {
  ...
  createGroup: (data: CreatePermissionGroupData) => api.post('/api/permissions/groups', data),
  ...
  getAvailable: (): Promise<AxiosResponse<Permission[]>> => api.get('/api/permissions/available'),
...
export const policiesApi = {
  ...
  get: (id: string): Promise<AxiosResponse<Policy>> => api.get(`/api/policies/${id}`),
  getStats: (): Promise<
    AxiosResponse<{
      total: number;
  ...
  upload: async (file: File, data: UploadPolicyData): Promise<Policy> => {
    ...
    const response = await api.post<Policy>('/api/policies', formData, {
      headers: { 'Content-Type': 'multipart/form-data' },
    });
  ...
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/policies/${id}`),
  getDownloadUrl: (id: string): Promise<AxiosResponse<{ url: string }>> =>
  ...
  uploadNewVersion: async (
    ...
    const response = await api.post<Policy>(`/api/policies/${id}/versions`, formData, {
      headers: { 'Content-Type': 'multipart/form-data' },
    });
    return response.data;
  },
...
export const commentsApi = {
  ...
  create: (data: CreateCommentData) => api.post('/api/comments', data),
  update: (id: string, data: UpdateCommentData) => api.put(`/api/comments/${id}`, data),
  delete: (id: string) => api.delete(`/api/comments/${id}`),
};

export const tasksApi = {
  list: (params?: TaskListParams) => api.get('/api/tasks', { params }),
...
export const assessmentsApi = {
  ...
  get: (id: string): Promise<AxiosResponse<VendorAssessment>> => api.get(`/api/assessments/${id}`),
  create: (
    data: CreateVendorAssessmentData | Record<string, unknown>
  ): Promise<AxiosResponse<VendorAssessment>> => api.post('/api/assessments', data),
  update: (
    id: string,
    data: UpdateVendorAssessmentData | Record<string, unknown>
  ): Promise<AxiosResponse<VendorAssessment>> => api.patch(`/api/assessments/${id}`, data),
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/assessments/${id}`),
  ...
  createRemediation: (id: string, data: CreateRemediationData) =>
    api.post(`/api/assessments/${id}/remediation`, data),
...
export const mappingsApi = {
  ...
  byRequirement: (requirementId: string) =>
    api.get(`/api/mappings/by-requirement/${requirementId}`),
...
export const dashboardApi = {
  ...
  getFull: (): Promise<AxiosResponse<FullDashboardResponse>> => api.get('/api/dashboard/full'),
...
export const integrationsApi = {
  ...
  get: (id: string): Promise<AxiosResponse<Integration>> => api.get(`/api/integrations/${id}`),
  getStats: (): Promise<
    AxiosResponse<{
      total: number;
      active: number;
  ...
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/integrations/${id}`),
  ...
  testCustomEndpoint: (
    id: string,
    data?: { endpointIndex?: number; baseUrl?: string; authConfig?: Record<string, unknown> }
...
export const configAsCodeApi = {
  ...
  getFile: (path: string, workspaceId?: string) =>
    api.get(`/api/config-as-code/files/${encodeURIComponent(path)}`, {
  ...
  updateFile: (
    ...
    api.put(`/api/config-as-code/files/${encodeURIComponent(path)}`, data, {
      params: workspaceId ? { workspaceId } : {},
    }),
  deleteFile: (path: string, workspaceId?: string) =>
    api.delete(`/api/config-as-code/files/${encodeURIComponent(path)}`, {
      params: workspaceId ? { workspaceId } : {},
    }),
  previewChanges: (data: {
    path: string;
  ...
  applyChanges: (
    ...
    api.post('/api/config-as-code/files/apply', data, {
      params: workspaceId ? { workspaceId } : {},
    }),
  getVersionHistory: (path: string, workspaceId?: string) =>
    api.get(`/api/config-as-code/files/${encodeURIComponent(path)}/versions`, {
      params: workspaceId ? { workspaceId } : {},
    }),
  refreshFromDatabase: (workspaceId?: string) =>
    api.post(
      '/api/config-as-code/files/refresh',
      {},
      { params: workspaceId ? { workspaceId } : {} }
    ),
};
...
export const auditsApi = {
  ...
  get: (id: string): Promise<AxiosResponse<Audit>> => api.get(`/api/audits/${id}`),
  create: (data: CreateAuditData): Promise<AxiosResponse<Audit>> => api.post('/api/audits', data),
  update: (id: string, data: UpdateAuditData): Promise<AxiosResponse<Audit>> =>
    api.patch(`/api/audits/${id}`, data),
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/audits/${id}`),
};

export const auditRequestsApi = {
  list: (params?: { status?: string; auditId?: string; assignedTo?: string }) =>
...
export const auditFindingsApi = {
  ...
  get: (id: string): Promise<AxiosResponse<AuditFinding>> => api.get(`/api/findings/${id}`),
  getStats: () => api.get('/api/findings/stats'),
  create: (
    data: CreateFindingData | Record<string, unknown>
  ): Promise<AxiosResponse<AuditFinding>> => api.post('/api/findings', data),
  update: (id: string, data: UpdateFindingData): Promise<AxiosResponse<AuditFinding>> =>
    api.patch(`/api/findings/${id}`, data),
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/findings/${id}`),
...
export const auditTemplatesApi = {
  ...
  update: (id: string, data: Record<string, unknown>) =>
    api.put(`/api/audit/templates/${id}`, data),
...
export const auditWorkpapersApi = {
  ...
  update: (id: string, data: Record<string, unknown>) =>
    api.put(`/api/audit/workpapers/${id}`, data),
...
export const auditTestProceduresApi = {
  ...
  update: (id: string, data: Record<string, unknown>) =>
    api.put(`/api/audit/test-procedures/${id}`, data),
...
export const auditRemediationApi = {
  ...
  updatePlan: (id: string, data: Record<string, unknown>) =>
    api.put(`/api/audit/remediation/${id}`, data),
...
export const auditPlanningApi = {
  list: (params?: { year?: number; status?: string }) => api.get('/api/audit/planning', { params }),
  ...
  getCapacity: (year: number) => api.get('/api/audit/planning/capacity', { params: { year } }),
...
export const auditReportsApi = {
  ...
  getManagementLetter: (auditId: string) =>
    api.get(`/api/audit/reports/${auditId}/management-letter`),
  getFindingsSummary: (auditId: string) => api.get(`/api/audit/reports/${auditId}/findings`),
};

// Audit AI
export const auditAIApi = {
  categorizeFinding: (data: {
    title: string;
    description: string;
    context?: string;
    framework?: string;
...
export const vendorsApi = {
  ...
  get: (id: string): Promise<AxiosResponse<Vendor>> => api.get(`/api/vendors/${id}`),
  ...
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/vendors/${id}`),
  ...
  analyzeDocument: (
    vendorId: string,
    documentId: string
  ): Promise<AxiosResponse<SOC2AnalysisResult>> =>
    api.post(`/api/vendors/${vendorId}/documents/${documentId}/analyze`),
  // Risk Assessment Wizard endpoints
  submitRiskAssessment: (
    vendorId: string,
    data: VendorRiskAssessmentRequest
  ): Promise<AxiosResponse<VendorRiskAssessmentResult>> =>
    api.post(`/api/vendors/${vendorId}/risk-assessment`, data),
  getLatestRiskAssessment: (
    vendorId: string
  ): Promise<AxiosResponse<VendorRiskAssessmentResult | null>> =>
  ...
  initiateSecurityScan: (
    vendorId: string,
    targetUrl?: string
  ): Promise<AxiosResponse<VendorSecurityScanResult>> =>
    api.post(`/api/vendors/${vendorId}/security-scan`, { targetUrl }),
  getLatestSecurityScan: (
    vendorId: string
  ): Promise<AxiosResponse<VendorSecurityScanResult | null>> =>
...
export const contractsApi = {
  list: (): Promise<AxiosResponse<Contract[]>> => api.get('/api/contracts'),
  get: (id: string): Promise<AxiosResponse<Contract>> => api.get(`/api/contracts/${id}`),
  ...
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/contracts/${id}`),
};
...
export const questionnairesApi = {
  ...
  }): Promise<AxiosResponse<Questionnaire[]>> => api.get('/api/questionnaires', { params }),
  get: (id: string): Promise<AxiosResponse<Questionnaire>> => api.get(`/api/questionnaires/${id}`),
  ...
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/questionnaires/${id}`),
  ...
  updateQuestion: (id: string, data: UpdateQuestionData) =>
    api.patch(`/api/questionnaires/questions/${id}`, data),
  deleteQuestion: (id: string) => api.delete(`/api/questionnaires/questions/${id}`),
  getStats: (organizationId: string) =>
    api.get('/api/questionnaires/stats', { params: { organizationId } }),
  getDashboardQueue: (
    organizationId: string
  ): Promise<AxiosResponse<QuestionnaireDashboardQueue>> =>
    api.get('/api/questionnaires/dashboard-queue', { params: { organizationId } }),
  getMyQueue: (organizationId: string) =>
    api.get('/api/questionnaires/my-queue', { params: { organizationId } }),
  ...
  findSimilarQuestions: (organizationId: string, questionText: string, excludeId?: string) =>
    api.get('/api/questionnaires/similar-questions', {
      params: { organizationId, questionText, excludeId },
    }),
...
export const knowledgeBaseApi = {
  ...
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/knowledge-base/${id}`),
  bulkCreate: (data: { entries: CreateKnowledgeBaseData[] }) =>
    api.post('/api/knowledge-base/bulk', data),
  ...
  getStats: (organizationId: string) =>
    api.get('/api/knowledge-base/stats', { params: { organizationId } }),
};
...
export const trustCenterApi = {
  ...
  updateConfig: (
    data: UpdateTrustCenterConfigData,
    params?: { organizationId?: string }
  ): Promise<AxiosResponse<TrustCenterConfig>> =>
    api.patch('/api/trust-center/config', data, { params }),
  getContent: (params?: {
    organizationId?: string;
    section?: string;
  }): Promise<AxiosResponse<TrustCenterContent[]>> =>
  ...
  updateContent: (
    id: string,
    data: UpdateTrustCenterContentData
  ): Promise<AxiosResponse<TrustCenterContent>> =>
  ...
  getPublic: (params?: { organizationId?: string }) =>
    api.get('/api/trust-center/public', { params }),
};
...
export const trustConfigApi = {
  ...
  update: (
    data: Partial<TrustConfiguration>,
    organizationId?: string
  ): Promise<AxiosResponse<TrustConfiguration>> =>
...
export const trustAiApi = {
  draftAnswer: (
    organizationId: string,
    questionText: string
  ): Promise<AxiosResponse<AnswerSuggestion>> =>
    api.post('/api/trust-ai/draft-answer', { questionText }, { params: { organizationId } }),
  categorizeQuestion: (
    organizationId: string,
    questionText: string
  ): Promise<AxiosResponse<QuestionCategorization>> =>
  ...
  improveAnswer: (
    ...
    api.post(
      '/api/trust-ai/improve-answer',
      { questionText, currentAnswer },
...
export const answerTemplatesApi = {
  list: (params?: {
    ...
    status?: string;
    search?: string;
  }): Promise<AxiosResponse<AnswerTemplate[]>> => api.get('/api/answer-templates', { params }),
  ...
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/answer-templates/${id}`),
  ...
  ): Promise<AxiosResponse<{ content: string; templateId: string; templateTitle: string }>> =>
    api.post(`/api/answer-templates/${id}/apply`, { variables }),
  getStats: (organizationId: string) =>
    api.get('/api/answer-templates/stats', { params: { organizationId } }),
  getCategories: (organizationId: string) =>
    api.get('/api/answer-templates/categories', { params: { organizationId } }),
};
...
export const risksApi = {
  ...
  get: (id: string): Promise<AxiosResponse<RiskDetail>> => api.get(`/api/risks/${id}`),
  create: (data: CreateRiskData): Promise<AxiosResponse<Risk>> => api.post('/api/risks', data),
  update: (id: string, data: UpdateRiskData): Promise<AxiosResponse<Risk>> =>
    api.put(`/api/risks/${id}`, data),
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/risks/${id}`),
  markReviewed: (id: string, notes?: string) => api.post(`/api/risks/${id}/review`, { notes }),
  ...
  validateRisk: (
    id: string,
    data: { approved: boolean; reason?: string; riskAssessorId?: string }
  ...
  reviewAssessment: (
    id: string,
    data: { approved: boolean; notes?: string; revisionNotes?: string; declinedReason?: string }
  ...
  assignExecutiveApprover: (id: string, approverId: string) =>
    api.post(`/api/risks/${id}/treatment/assign-approver`, { executiveApproverId: approverId }),
  ...
  linkAssets: (id: string, assetIds: string[]) => api.post(`/api/risks/${id}/assets`, { assetIds }),
  unlinkAsset: (id: string, assetId: string) => api.delete(`/api/risks/${id}/assets/${assetId}`),
...
export const riskScenariosApi = {
  ...
  get: (id: string): Promise<AxiosResponse<RiskScenario>> => api.get(`/api/risk-scenarios/${id}`),
  ...
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/risk-scenarios/${id}`),
  ...
  getLibrary: (): Promise<AxiosResponse<RiskScenario[]>> => api.get('/api/risk-scenarios/library'),
  getLibraryByCategory: (): Promise<
    AxiosResponse<{ category: string; templates: RiskScenario[] }[]>
  > => api.get('/api/risk-scenarios/library/by-category'),
  getCategories: (): Promise<AxiosResponse<string[]>> => api.get('/api/risk-scenarios/categories'),
...
export const riskTasksApi = {
  ...
  getMyTasks: (
    params?: RiskTaskFilterParams
  ): Promise<AxiosResponse<RiskWorkflowTaskListResponse>> =>
  ...
  getStats: (): Promise<AxiosResponse<RiskWorkflowTaskStats>> => api.get('/api/risk-tasks/stats'),
  ...
  create: (
    riskId: string,
    data: CreateRiskWorkflowTaskData
  ): Promise<AxiosResponse<RiskWorkflowTask>> => api.post(`/api/risk-tasks/risk/${riskId}`, data),
  ...
  update: (
    taskId: string,
    data: UpdateRiskWorkflowTaskData
  ): Promise<AxiosResponse<RiskWorkflowTask>> => api.put(`/api/risk-tasks/${taskId}`, data),
  ...
  complete: (
    taskId: string,
    data?: { completionNotes?: string; resultingAction?: string }
  ): Promise<AxiosResponse<RiskWorkflowTask>> =>
...
Object.assign(risksApi, {
  ...
  updateControlEffectiveness: (
    id: string,
    controlId: string,
    data: { effectiveness: string; notes?: string }
  ...
  reviewAssessment: (
    id: string,
    data: { approved: boolean; notes?: string; declinedReason?: string }
  ) => api.post(`/api/risks/${id}/assessment/review`, data),
  completeRevision: (id: string, data: Partial<RiskAssessmentData>) =>
    api.post(`/api/risks/${id}/assessment/revision`, data),
  // Risk Treatment
  submitTreatmentDecision: (
    id: string,
    data: {
  ...
  submitExecutiveApproval: (
    id: string,
    data: { approved: boolean; notes?: string; deniedReason?: string }
  ) => api.post(`/api/risks/${id}/treatment/executive-approval`, data),
...
export const assetsApi = {
  ...
  get: (id: string): Promise<AxiosResponse<Asset>> => api.get(`/api/assets/${id}`),
  create: (data: CreateAssetData): Promise<AxiosResponse<Asset>> => api.post('/api/assets', data),
  update: (id: string, data: UpdateAssetData): Promise<AxiosResponse<Asset>> =>
    api.put(`/api/assets/${id}`, data),
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/assets/${id}`),
  getStats: () => api.get('/api/assets/stats'),
  getSources: (): Promise<AxiosResponse<string[]>> => api.get('/api/assets/sources'),
  getDepartments: (): Promise<AxiosResponse<string[]>> => api.get('/api/assets/departments'),
...
export const riskConfigApi = {
  ...
  addCategory: (category: RiskCategory) => api.post('/api/risk-config/categories', category),
  removeCategory: (categoryId: string) => api.delete(`/api/risk-config/categories/${categoryId}`),
...
export const tprmConfigApi = {
  ...
  update: (data: Partial<TprmConfiguration>) =>
    api.put<TprmConfiguration>('/api/tprm-config', data),
...
export const notificationsConfigApi = {
  ...
  getEmailStatus: async (): Promise<EmailStatus> => {
    try {
      const response = await api.get<{ success: boolean; data: EmailStatus }>(
        '/api/notifications-config/email-status'
      );
  ...
  testSlack: (channel?: string) => api.post('/api/notifications-config/test-slack', { channel }),
...
export const seedApi = {
  ...
  resetData: (confirmationPhrase: string) => api.post('/api/seed/reset', { confirmationPhrase }),
...
export const customDashboardsApi = {
  ...
  duplicate: (id: string, name?: string) => api.post(`/api/dashboards/${id}/duplicate`, { name }),

  // Set as default dashboard
  setDefault: (id: string) => api.post(`/api/dashboards/${id}/set-default`),
...
export const aiApi = {
  // Configuration
  getConfig: (): Promise<AxiosResponse<AIConfig>> => api.get('/api/ai/config'),
  updateConfig: (data: Partial<AIConfig>) => api.put('/api/ai/config', data),
  getStatus: (): Promise<
    AxiosResponse<{
      available: boolean;
      config: AIConfig;
  ...
  ): Promise<AxiosResponse<{ success: boolean; data: RiskScoringResponse }>> =>
    api.post('/api/ai/risk/score', data),
  recommendRiskTreatment: (
    data: RiskTreatmentRequest
  ): Promise<AxiosResponse<{ success: boolean; data: RiskTreatmentResponse }>> =>
    api.post('/api/ai/risk/treatment', data),

  // Categorization
  categorize: (
    data: CategorizationRequest
  ): Promise<AxiosResponse<{ success: boolean; data: CategorizationResponse }>> =>
    api.post('/api/ai/categorize', data),

  // Smart Search
  interpretSearch: (
    data: SmartSearchRequest
  ): Promise<AxiosResponse<{ success: boolean; data: SmartSearchInterpretation }>> =>
    api.post('/api/ai/search/interpret', data),

  // Control Mapping
  suggestControlMappings: (
    data: ControlMappingSuggestionRequest
  ): Promise<
    AxiosResponse<{ success: boolean; data: { suggestions: ControlMappingSuggestion[] } }>
  > => api.post('/api/ai/controls/mapping-suggestions', data),

  // Policy Generation
  generatePolicyDraft: (
    data: PolicyDraftRequest
  ): Promise<AxiosResponse<{ success: boolean; data: PolicyDraftResponse }>> =>
    api.post('/api/ai/policies/draft', data),

  // Compliance Gap Analysis
  analyzeComplianceGaps: (
    data: ComplianceGapRequest
  ): Promise<AxiosResponse<{ success: boolean; data: ComplianceGapResponse }>> =>
...
export const mcpApi = {
  ...
  healthCheck: (
    ...
    AxiosResponse<{ success: boolean; data: { isHealthy: boolean; latencyMs?: number } }>
  ...
  ): Promise<AxiosResponse<{ success: boolean; data: MCPServer }>> =>
    api.post(`/api/mcp/templates/${templateId}/deploy`, { env }),

  // Capabilities
  getCapabilities: (
    serverId: string
  ): Promise<AxiosResponse<{ success: boolean; data: MCPServer['capabilities'] }>> =>
  ...
  ): Promise<AxiosResponse<{ success: boolean; data: { result: unknown } }>> =>
    api.post('/api/mcp/tools/call', { serverId, toolName, arguments: args }),

  callToolsBatch: (
    calls: Array<{ serverId: string; toolName: string; arguments?: Record<string, unknown> }>,
    parallel?: boolean
  ): Promise<AxiosResponse<{ success: boolean; data: { results: unknown[] } }>> =>
  ...
  readResource: (
    serverId: string,
    uri: string
  ): Promise<AxiosResponse<{ success: boolean; data: { content: unknown } }>> =>
  ...
  ): Promise<AxiosResponse<{ success: boolean; data: { messages: unknown[] } }>> =>
  ...
  ): Promise<AxiosResponse<{ success: boolean; data: MCPExecution }>> =>
...
export const customReportsApi = {
  ...
  list: async (): Promise<CustomReportConfig[]> => {
    try {
      const response = await api.get<{ success: boolean; data: CustomReportConfig[] }>(
        '/api/custom-reports'
      );
      return response.data.data || [];
    } catch (error: unknown) {
...
export const scheduledReportsApi = {
  ...
  list: async (): Promise<ScheduledReport[]> => {
    try {
      const response = await api.get<{ success: boolean; data: ScheduledReport[] }>(
...
export const apiKeysApi = {
  list: (params?: {
    ...
    page?: number;
    limit?: number;
  }): Promise<AxiosResponse<ApiKeyListResponse>> => api.get('/api/api-keys', { params }),
  get: (id: string): Promise<AxiosResponse<ApiKey>> => api.get(`/api/api-keys/${id}`),
  getStats: (): Promise<AxiosResponse<ApiKeyStats>> => api.get('/api/api-keys/stats'),
  getScopes: (): Promise<AxiosResponse<{ scopes: string[] }>> => api.get('/api/api-keys/scopes'),
  ...
  revoke: (id: string): Promise<AxiosResponse<void>> => api.post(`/api/api-keys/${id}/revoke`),
  regenerate: (id: string): Promise<AxiosResponse<ApiKeyWithSecret>> =>
    api.post(`/api/api-keys/${id}/regenerate`),
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/api-keys/${id}`),
};
...
export const calendarApi = {
  ...
  get: (id: string): Promise<AxiosResponse<CalendarEvent>> => api.get(`/api/calendar/events/${id}`),
  ...
  ): Promise<AxiosResponse<CalendarEvent>> => api.put(`/api/calendar/events/${id}`, data),
  delete: (id: string): Promise<AxiosResponse<void>> => api.delete(`/api/calendar/events/${id}`),
  exportIcal: (params?: {
    startDate?: string;
    endDate?: string;
    eventType?: string;
...
export const auditPortalApi = {
  ...
  updateUser: (
    auditId: string,
    userId: string,
    data: Partial<CreatePortalUserData>
  ): Promise<AxiosResponse<PortalUser>> =>
