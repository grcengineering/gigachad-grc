...
export const assessmentsApi = {
  ...
  createRemediation: (id: string, data: any) =>
...
export const integrationsApi = {
  ...
  saveCustomConfig: (id: string, config: any) =>
    api.put(`/api/integrations/${id}/custom-config`, config),
  testCustomEndpoint: (
    id: string,
    data?: { endpointIndex?: number; baseUrl?: string; authConfig?: any }
...
export const auditsApi = {
  list: (params?: { status?: string; auditType?: string }) => api.get('/api/audits', { params }),
...
export const notificationsApi = {
  ...
  updatePreferences: (
    preferences: Array<{ notificationType: string; inApp: boolean; email: boolean }>
