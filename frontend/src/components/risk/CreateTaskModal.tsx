...
const taskTypes = [
  { value: 'custom', label: 'Custom Task', description: 'A custom task for any purpose' },
  {
    value: 'validate',
    label: 'Validate Risk',
    description: 'Review and validate the submitted risk',
  },
  { value: 'assess', label: 'Risk Assessment', description: 'Analyze and assess the risk' },
  {
    value: 'review_assessment',
    label: 'GRC Review',
    description: 'Review the submitted assessment',
  },
  {
    value: 'treatment_decision',
    label: 'Treatment Decision',
    description: 'Decide on treatment approach',
  },
  {
    value: 'executive_approval',
    label: 'Executive Approval',
    description: 'Executive sign-off required',
  },
  {
    value: 'mitigation_update',
    label: 'Mitigation Update',
    description: 'Provide progress update',
  },
];
...
export default function CreateTaskModal({ riskId, onClose, onSuccess }: CreateTaskModalProps) {
  ...
  const filteredUsers = users.filter(
    (u: { firstName: string; lastName: string; email: string }) =>
      userSearch === '' ||
          ...
          <form onSubmit={handleSubmit} className="p-4 space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
              ...
              <button
                type="submit"
                disabled={
                  createMutation.isPending || !formData.title.trim() || !formData.assigneeId
                }
