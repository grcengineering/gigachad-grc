...
export type StatCardTone = 'brand' | 'accent' | 'emerald' | 'red' | 'amber' | 'blue' | 'purple' | 'neutral';

const toneStyles: Record<StatCardTone, { iconBg: string; spark: { stroke: string; fill: string } }> = {
  brand: {
          ...
          <div className="min-w-0 flex-1">
            ...
            {delta !== undefined && (
              <div className={cn('flex items-center gap-1 mt-1.5 text-xs font-medium', deltaColor)}>
                ...
                <span>
                  {deltaZero ? '0' : `${deltaPositive ? '+' : ''}${delta}`}%
                </span>
