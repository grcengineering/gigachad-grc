...
export default function MappingGaps() {
  ...
  const requirementColumns: DataTableColumn<RequirementGap>[] = [
    {
      ...
      cell: ({ row }) => (
        <CategoryChip value={row.original.framework} case="upper" />
      ),
    },
    {
      id: 'requirementCode',
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <span className="text-surface-900">{row.original.requirementTitle}</span>
      ),
    },
    {
      ...
      cell: ({ row }) => (
        <span className="text-surface-700 tabular-nums">
          {row.original.mappedControlCount}
        </span>
      ),
    },
    {
  ...
  const controlColumns: DataTableColumn<ControlGap>[] = [
    ...
    },
    {
      ...
      mobileLabel: 'Control',
      cell: ({ row }) => (
        <span className="text-surface-900">{row.original.controlTitle}</span>
      ),
    },
    {
      id: 'evidenceCount',
  ...
  const evidenceColumns: DataTableColumn<EvidenceGap>[] = [
    {
      ...
      mobileLabel: 'Evidence',
      cell: ({ row }) => (
        <span className="text-surface-900">{row.original.evidenceTitle}</span>
      ),
    },
    {
      id: 'type',
