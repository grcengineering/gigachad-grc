    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-brand-500/20 to-purple-500/20 rounded-xl border border-brand-500/30 p-8 text-center">
        ...
        <p className="text-surface-700 max-w-2xl mx-auto">
          A comprehensive security awareness and training module is being developed. This will help
          you manage employee training, track compliance, and run phishing simulations.
        </p>
      </div>
