      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {templates.map((t) => {
            ...
            const requests =
              t.requestsCount ?? (Array.isArray(t.requestTemplates) ? t.requestTemplates.length : 0);
              ...
              <Card key={t.id} className="flex flex-col">
                <CardBody density="cozy" className="flex-1 flex flex-col gap-3">
                  ...
                  <dl className="grid grid-cols-3 gap-2 pt-2 border-t border-surface-200">
                    <div>
                      <dt className="text-xs text-surface-500 uppercase tracking-wider">Controls</dt>
                      <dd className="text-h3 text-surface-900 tabular-nums">{controls}</dd>
                    </div>
                    <div>
                      <dt className="text-xs text-surface-500 uppercase tracking-wider">Procedures</dt>
                      <dd className="text-h3 text-surface-900 tabular-nums">{procedures}</dd>
                    </div>
                    <div>
                      <dt className="text-xs text-surface-500 uppercase tracking-wider">Requests</dt>
