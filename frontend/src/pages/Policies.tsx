...
export default function Policies() {
  ...
  const columns: DataTableColumn<Policy>[] = [
    ...
    },
    {
      ...
      mobileLabel: 'Version',
      cell: ({ row }) => (
        <span className="font-mono text-small text-surface-600">v{row.original.version}</span>
      ),
    },
    {
      id: 'status',
  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      <FilterBar
        ...
        onClearAll={activeFilters.length ? () => setSearch('') : undefined}
      >
        <Input
          inputSize="sm"
          className="w-72"
      ...
      <DataTable
        ...
        emptyState={
          <EmptyState
            ...
            description={
              search ? 'Try clearing your search.' : 'Upload your first policy to get started.'
            }
            action={
              search ? (
  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <div>
          <Label htmlFor="pol-title" required>
            Title
          </Label>
          <Input
            id="pol-title"
