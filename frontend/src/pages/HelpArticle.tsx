  ...
  return (
    <article className="prose prose-invert max-w-none">
      ...
      <section className="mb-8">
        ...
        <div className="bg-surface-800/50 border border-surface-700 rounded-lg p-4 mt-4">
          ...
          <ul className="text-surface-600 space-y-1 text-sm list-disc list-inside">
            <li>
              <strong>Brand consistency</strong> - Keep visitors on your domain throughout their
              security review
            </li>
            <li>
              <strong>Professional appearance</strong> - Builds trust with a URL that matches your
              brand
            </li>
            <li>
              <strong>Easy to remember</strong> - Share a simple, memorable URL with stakeholders
            </li>
            <li>
              <strong>SEO benefits</strong> - Content lives on your domain
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="space-y-2">
          {[
            ...
            {
              text: 'Domain ownership - You own or control the domain you want to use',
              done: false,
            },
        ...
        <div className="bg-amber-50 dark:bg-yellow-500/10 border border-amber-300 dark:border-yellow-500/30 rounded-lg p-4 mt-4">
          <p className="text-amber-700 dark:text-yellow-600 text-sm">
            <strong>Note:</strong> If you don't have access to modify your DNS records, contact your
            IT administrator or the person who manages your domain.
          </p>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <ol className="space-y-3 text-surface-700">
          ...
          <li className="flex gap-3">
            ...
            <span>
              Navigate to <strong>Trust</strong> → <strong>Trust Center Settings</strong> in the
              sidebar
            </span>
          </li>
          <li className="flex gap-3">
            ...
            <span>
              Click on the <strong>Custom Domain</strong> tab
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
        ...
        <div className="bg-surface-800 rounded-lg overflow-hidden mb-6">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-surface-700">
              ...
              <tr>
                <td className="px-4 py-3 text-surface-600">Host/Name</td>
                <td className="px-4 py-3">
              ...
              <tr>
                <td className="px-4 py-3 text-surface-600">Value/Points to</td>
              ...
              <tr>
                <td className="px-4 py-3 text-surface-600">TTL</td>
                <td className="px-4 py-3">
          ...
          <details className="bg-surface-800/50 border border-surface-700 rounded-lg">
            ...
            <div className="px-4 pb-4 text-sm text-surface-600 space-y-2">
              <ol className="list-decimal list-inside space-y-1">
                ...
                <li>
                  Click <strong>DNS</strong> in the sidebar
                </li>
                <li>
                ...
                <li>
                  <strong>Important:</strong> Set proxy status to "DNS only" (gray cloud)
                </li>
                <li>
                  Click <strong>Save</strong>
                </li>
              ...
              <div className="bg-red-500/10 border border-red-500/30 rounded p-2 mt-2">
                <p className="text-red-600 text-xs">
                  ⚠️ Make sure the proxy is disabled (gray cloud). Orange cloud may cause SSL
                  issues.
                </p>
              </div>
            </div>
          ...
          <details className="bg-surface-800/50 border border-surface-700 rounded-lg">
            ...
            <div className="px-4 pb-4 text-sm text-surface-600 space-y-2">
              <ol className="list-decimal list-inside space-y-1">
                ...
                <li>
                  Go to <strong>My Products</strong> → <strong>Domains</strong>
                </li>
                <li>
                  Click <strong>DNS</strong> next to your domain
                </li>
                <li>
                  Click <strong>Add</strong> in the Records section
                </li>
                <li>
          ...
          <details className="bg-surface-800/50 border border-surface-700 rounded-lg">
            ...
            <div className="px-4 pb-4 text-sm text-surface-600 space-y-2">
              <ol className="list-decimal list-inside space-y-1">
                ...
                <li>
                  Navigate to <strong>Route 53</strong> → <strong>Hosted zones</strong>
                </li>
          ...
          <details className="bg-surface-800/50 border border-surface-700 rounded-lg">
            ...
            <div className="px-4 pb-4 text-sm text-surface-600 space-y-2">
              <ol className="list-decimal list-inside space-y-1">
                ...
                <li>
                  Go to <strong>Domain List</strong> → click <strong>Manage</strong>
                </li>
                <li>
                  Click <strong>Advanced DNS</strong>
                </li>
                <li>
      ...
      <section className="mb-8">
        ...
        <p className="text-surface-700 mb-4">
          DNS changes can take anywhere from a few minutes to 48 hours to propagate (most take under
          30 minutes).
        </p>
    ...
    <article className="prose prose-invert max-w-none">
      <section className="mb-8">
        ...
        <p className="text-surface-700">
          ...
          customers, and partners. It serves as a central hub for security information, reducing the
        ...
        <div className="bg-surface-800/50 border border-surface-700 rounded-lg p-4 mt-4">
          ...
          <ul className="text-surface-600 space-y-1 text-sm list-disc list-inside">
            ...
            <li>
              <strong>Security policies</strong> - Share approved policy documents
            </li>
            <li>
              <strong>Security features</strong> - Encryption, access controls, monitoring
            </li>
            <li>
              <strong>Privacy practices</strong> - Data handling and retention policies
            </li>
            <li>
              <strong>Incident response</strong> - Your approach to security incidents
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <ol className="space-y-3 text-surface-700">
          ...
          <li className="flex gap-3">
            ...
            <span>
              On the <strong>General</strong> tab, toggle <strong>Enable Trust Center</strong> to on
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <span>
              Enter your <strong>Security Email</strong> for inquiries
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <span>
              Optionally add a <strong>Support URL</strong> for additional resources
            </span>
          </li>
        </ol>
      </section>
      ...
      <section className="mb-8">
        ...
        <ol className="space-y-3 text-surface-700">
          <li className="flex gap-3">
            ...
            <span>
              Click on the <strong>Branding</strong> tab
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <span>
              Enter your <strong>Company Name</strong> as you want it displayed
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <span>
              Add a <strong>Description</strong> (e.g., "Security-first cloud platform")
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <span>
              Upload your <strong>Logo URL</strong> (recommended: 200x50px PNG with transparency)
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <span>
              Select a <strong>Primary Color</strong> that matches your brand
            </span>
          </li>
        </ol>
      </section>
      ...
      <section className="mb-8">
        ...
        <ol className="space-y-3 text-surface-700">
          <li className="flex gap-3">
            ...
            <span>
              Navigate to <strong>Trust</strong> → <strong>Trust Center</strong> in the sidebar
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <span>
              Click <strong>Add Content</strong> for each section you want to populate
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <span>
              Enter a <strong>Title</strong> and <strong>Description</strong>
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
        ...
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 mt-4">
          <p className="text-blue-600 text-sm">
            <strong>Tip:</strong> Start with your compliance certifications and most-requested
            security documentation to provide immediate value to visitors.
          </p>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="space-y-3 text-surface-700">
          <li className="flex gap-3">
            <span className="text-brand-400">•</span>
            <span>
              <strong>Direct Link:</strong> Copy the URL from Trust Center Settings → Embed Code tab
            </span>
          </li>
          <li className="flex gap-3">
            <span className="text-brand-400">•</span>
            <span>
              <strong>Website Embed:</strong> Use the iframe code to embed on your website
            </span>
          </li>
          <li className="flex gap-3">
            <span className="text-brand-400">•</span>
            <span>
              <strong>Security Button:</strong> Add a branded "Security" button to your site
            </span>
          </li>
          <li className="flex gap-3">
            <span className="text-brand-400">•</span>
            <span>
              <strong>Custom Domain:</strong> Set up a custom URL like trust.yourcompany.com
            </span>
          </li>
        </ul>
      </section>
    ...
    <article className="prose prose-invert max-w-none">
      <section className="mb-8">
        ...
        <p className="text-surface-700">
          ...
          manually gathering screenshots and documents, integrations pull data directly from your
          systems.
        </p>
        ...
        <div className="bg-surface-800/50 border border-surface-700 rounded-lg p-4 mt-4">
          ...
          <ul className="text-surface-600 space-y-1 text-sm list-disc list-inside">
            ...
            <li>
              <strong>Identity & Access</strong> - Okta, Azure AD user access reviews
            </li>
            <li>
              <strong>DevOps & CI/CD</strong> - GitHub, GitLab, Jenkins security configs
            </li>
            <li>
              <strong>Security Tools</strong> - Vulnerability scanners, SIEM, EDR
            </li>
            <li>
              <strong>HR & Background Check</strong> - Employee verification, training records
            </li>
            <li>
              <strong>Communication</strong> - Slack, Teams for audit trails
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <ol className="space-y-3 text-surface-700">
          <li className="flex gap-3">
            ...
            <span>
              Navigate to <strong>Data</strong> → <strong>Integrations</strong> in the sidebar
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4">
          <div className="bg-surface-800/50 border border-surface-700 rounded-lg p-4">
            ...
            <ul className="text-surface-600 text-sm list-disc list-inside">
      ...
      <section className="mb-8">
        ...
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
          <p className="text-blue-600 text-sm">
            <strong>Tip:</strong> Start with the evidence types required for your current compliance
            frameworks. You can always add more later.
          </p>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <ol className="space-y-3 text-surface-700">
          <li className="flex gap-3">
            ...
            <span>
              Click <strong>Test Connection</strong> to verify credentials work
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <span>
              Run a <strong>Manual Sync</strong> to pull initial data
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <span>
              Review collected evidence in <strong>Data</strong> → <strong>Evidence</strong>
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
    ...
    <article className="prose prose-invert max-w-none">
      <section className="mb-8">
        ...
        <p className="text-surface-700">
          ...
          HIPAA, or multiple frameworks simultaneously, the platform maps your controls to framework
          requirements.
        </p>
      ...
      <section className="mb-8">
        ...
        <ol className="space-y-3 text-surface-700">
          <li className="flex gap-3">
            ...
            <span>
              Navigate to <strong>Compliance</strong> → <strong>Frameworks</strong> in the sidebar
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <span>
              Click <strong>Add Framework</strong>
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
        ...
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 mt-4">
          <p className="text-blue-600 text-sm">
            <strong>Tip:</strong> If you're new to compliance, start with SOC 2 Type II - it's
            widely recognized and covers foundational security controls that map well to other
            frameworks.
          </p>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-surface-700 mb-4">
          Each framework has requirements that need to be satisfied. Map your existing controls to
          these requirements:
        </p>
        <ol className="space-y-3 text-surface-700">
          <li className="flex gap-3">
          ...
          <li className="flex gap-3">
            ...
            <span>
              Click <strong>Map Control</strong> and select existing controls or create new ones
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
        ...
        <div className="bg-surface-800/50 border border-surface-700 rounded-lg p-4 mt-4">
          ...
          <ul className="text-surface-600 text-sm list-disc list-inside mt-2">
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-surface-700">
              <tr>
                ...
                <td className="px-4 py-3 text-surface-600">
                  All mapped controls are implemented with current evidence
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3">
                ...
                <td className="px-4 py-3 text-surface-600">
                  Some controls implemented, evidence may be outdated
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3">
                ...
                <td className="px-4 py-3 text-surface-600">
                  Required controls missing or failed testing
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3">
                  <span className="px-2 py-1 bg-surface-600 text-surface-700 rounded text-xs">
                    Not Applicable
                  </span>
                </td>
                <td className="px-4 py-3 text-surface-600">
                  Requirement doesn't apply to your organization
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <section className="mb-8">
        ...
        <ul className="space-y-3 text-surface-700">
          <li className="flex gap-3">
            <span className="text-brand-400">•</span>
            <span>
              <strong>Generate reports</strong> - Export compliance status by framework
            </span>
          </li>
          <li className="flex gap-3">
            <span className="text-brand-400">•</span>
            <span>
              <strong>Collect evidence</strong> - Pull together all evidence for each control
            </span>
          </li>
          <li className="flex gap-3">
            <span className="text-brand-400">•</span>
            <span>
              <strong>Track requests</strong> - Manage auditor evidence requests in one place
            </span>
          </li>
          <li className="flex gap-3">
            <span className="text-brand-400">•</span>
            <span>
              <strong>Identify gaps</strong> - See what needs attention before the audit
            </span>
          </li>
        </ul>
      </section>
    ...
    <article className="prose prose-invert max-w-none">
      <section className="mb-8">
        ...
        <p className="text-surface-700">
          ...
          can impact your organization, making vendor security a critical component of your overall
          security program.
        </p>
        ...
        <div className="bg-surface-800/50 border border-surface-700 rounded-lg p-4 mt-4">
          ...
          <ul className="text-surface-600 space-y-1 text-sm list-disc list-inside">
            ...
            <li>
              <strong>Risk assessments</strong> - Evaluate vendor security posture
            </li>
            <li>
              <strong>Questionnaires</strong> - Send and track security questionnaires
            </li>
            <li>
              <strong>Contract management</strong> - Track agreements and SLAs
            </li>
            <li>
              <strong>Continuous monitoring</strong> - Ongoing risk surveillance
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <ol className="space-y-3 text-surface-700">
          <li className="flex gap-3">
            ...
            <span>
              Navigate to <strong>Third Party Risk</strong> → <strong>Vendors</strong>
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <span>
              Click <strong>Add Vendor</strong>
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-surface-700">
              <tr>
                ...
                <td className="px-4 py-3 text-surface-600">
                  Access to sensitive data, critical infrastructure
                </td>
                <td className="px-4 py-3 text-surface-600">Quarterly</td>
              </tr>
              <tr>
                <td className="px-4 py-3">
                ...
                <td className="px-4 py-3 text-surface-600">Access to internal systems, PII</td>
                <td className="px-4 py-3 text-surface-600">Semi-annually</td>
              </tr>
              <tr>
                <td className="px-4 py-3">
                  <span className="px-2 py-1 bg-yellow-500/20 text-yellow-600 rounded text-xs">
                ...
                <td className="px-4 py-3 text-surface-600">
                  Limited data access, business operations
                </td>
                <td className="px-4 py-3 text-surface-600">Annually</td>
              </tr>
              <tr>
                <td className="px-4 py-3">
                  <span className="px-2 py-1 bg-green-500/20 text-green-600 rounded text-xs">
                ...
                <td className="px-4 py-3 text-surface-600">
                  No data access, minimal business impact
                </td>
                <td className="px-4 py-3 text-surface-600">Every 2 years</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section className="mb-8">
        ...
        <ol className="space-y-3 text-surface-700">
          <li className="flex gap-3">
            ...
            <span>
              Click on a vendor and select <strong>Start Assessment</strong>
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
        ...
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 mt-4">
          <p className="text-blue-600 text-sm">
            <strong>Tip:</strong> Request vendors' SOC 2 Type II reports first - they provide
            comprehensive assurance and can reduce questionnaire burden.
          </p>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <div className="bg-surface-800/50 border border-surface-700 rounded-lg p-4 mt-4">
          ...
          <ul className="text-surface-600 space-y-1 text-sm list-disc list-inside">
            ...
            <li>
              <strong>Evidence requests</strong> - Track and fulfill auditor requests
            </li>
            <li>
              <strong>Findings management</strong> - Document and track remediation
            </li>
            <li>
              <strong>Audit reports</strong> - Generate status and completion reports
            </li>
            <li>
              <strong>Audit log</strong> - Complete history of compliance activities
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <ol className="space-y-3 text-surface-700">
          <li className="flex gap-3">
            ...
            <span>
              Navigate to <strong>Audit</strong> → <strong>Audits</strong>
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <span>
              Click <strong>Create Audit</strong>
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
      ...
      <section className="mb-8">
        ...
        <ol className="space-y-3 text-surface-700">
          <li className="flex gap-3">
            ...
            <span>
              Click <strong>Add Request</strong> on an audit
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
        ...
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 mt-4">
          <p className="text-blue-600 text-sm">
            <strong>Tip:</strong> Use the evidence library to quickly find and attach previously
            collected evidence. Integration-collected evidence is automatically timestamped and
            verified.
          </p>
        </div>
      </section>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-surface-700">
              <tr>
                ...
                <td className="px-4 py-3 text-surface-600">
                  Audit scope and timeline being defined
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3">
                ...
                <td className="px-4 py-3 text-surface-600">
                  Evidence collection and auditor review underway
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3">
                ...
                <td className="px-4 py-3 text-surface-600">
                  Awaiting final auditor review and report
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3">
                ...
                <td className="px-4 py-3 text-surface-600">Audit finished, report issued</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section className="mb-8">
        ...
        <ol className="space-y-3 text-surface-700">
          <li className="flex gap-3">
            ...
            <span>
              Go to <strong>Audit</strong> → <strong>Findings</strong>
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <span>
              Click <strong>Add Finding</strong> and document the issue
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
        ...
        <ol className="space-y-4 text-surface-700">
          ...
          <li className="flex gap-3">
            ...
            <div>
              ...
              <ul className="mt-2 ml-4 space-y-1 text-sm text-surface-600">
                <li>
                  • <strong>Project Name:</strong> gigachad-grc
                </li>
                <li>
                  • <strong>Database Password:</strong> Use a strong password
                </li>
                <li>
      ...
      <section className="mb-8">
        ...
        <ol className="space-y-4 text-surface-700">
          <li className="flex gap-3">
            ...
            <span>
              In Okta Admin Console, go to <strong>Applications → Create App Integration</strong>
            </span>
          </li>
          <li className="flex gap-3">
            <span className="bg-surface-700 text-surface-200 w-6 h-6 rounded-full flex items-center justify-center text-sm flex-shrink-0">
          ...
          <li className="flex gap-3">
            ...
            <span>
              Note your <strong>Client ID</strong> and <strong>Issuer URL</strong>
            </span>
          </li>
        </ol>
      </section>
          ...
          {[
            {
              ...
              desc: 'Replace Keycloak with Okta OIDC',
              time: '2-3 days',
            },
            {
              phase: '2',
              title: 'Database Migration',
              desc: 'Move PostgreSQL to Supabase',
              time: '1 day',
            },
            {
              phase: '3',
              title: 'API Migration',
              desc: 'Convert NestJS to Vercel functions',
              time: '5-7 days',
            },
            {
              phase: '4',
              title: 'Storage Migration',
              desc: 'Move RustFS to Supabase Storage',
              time: '1-2 days',
            },
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4">
          <div className="bg-surface-800 rounded-lg p-4">
            ...
            <p className="text-surface-600 text-sm mb-2">
              Use for all application queries. Handles connection pooling automatically.
            </p>
            <code className="text-surface-700 text-xs break-all">
          ...
          <div className="bg-surface-800 rounded-lg p-4">
            ...
            <p className="text-surface-600 text-sm mb-2">
              Use only for database migrations and schema changes.
            </p>
            <code className="text-surface-700 text-xs break-all">
        ...
        <div className="space-y-4">
          <div className="bg-surface-800 rounded-lg p-4">
            ...
            <ul className="text-surface-600 text-sm space-y-1">
              ...
              <li>
                • <strong>Grant Type:</strong> Authorization Code with PKCE
              </li>
              <li>
                • <strong>Redirect URI:</strong> https://your-app.vercel.app/login/callback
              </li>
              <li>
                • <strong>Post-Logout URI:</strong> https://your-app.vercel.app
              </li>
            </ul>
          </div>
          <div className="bg-surface-800 rounded-lg p-4">
            ...
            <ul className="text-surface-600 text-sm space-y-1">
              ...
              <li>
                • <strong>compliance_manager</strong> - Manage controls, policies
              </li>
              <li>
                • <strong>auditor</strong> - View audit information
              </li>
              <li>
  ...
  return (
    <article className="prose prose-invert max-w-none">
        ...
        <div className="bg-surface-800/50 border border-surface-700 rounded-lg p-4 mt-4">
          ...
          <ul className="text-surface-600 space-y-1 text-sm list-disc list-inside">
            <li>
              ...
              Okta, Google Workspace, Jamf
            </li>
            <li>
              <strong>GRC Compliance Automation</strong> - Control testing and gap analysis for SOC
              2, ISO 27001, HIPAA, GDPR
            </li>
            <li>
              <strong>GRC AI Assistant</strong> - AI-powered risk analysis, policy drafting, and
              control suggestions
            </li>
            <li>
              <strong>External Servers</strong> - GitHub, Slack, PostgreSQL, Puppeteer, and more
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <ol className="space-y-3 text-surface-700">
          <li className="flex gap-3">
            ...
            <span>
              Navigate to <strong>Settings → MCP Servers</strong> in the sidebar
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <span>
              Click <strong>Add Server</strong> to open the template selection modal
            </span>
          </li>
        </ol>
      </section>
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-surface-800/50 border border-surface-700 rounded-lg p-4">
            ...
            <p className="text-surface-600 text-sm mb-2">
              Best for running automated compliance checks against your controls.
            </p>
            <p className="text-surface-500 text-xs">
      ...
      <section className="mb-8">
        ...
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
          <p className="text-blue-600 text-sm">
            <strong>Tip:</strong> Only configure the integrations you need. Leave others blank and
      ...
      <section className="mb-8">
        ...
        <ol className="space-y-3 text-surface-700">
          <li className="flex gap-3">
            ...
            <span>
              Click <strong>Deploy Server</strong> to create the server instance
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 bg-brand-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
          ...
          <li className="flex gap-3">
            ...
            <span>
              Click the <strong>Play</strong> button to connect and start the server
            </span>
          </li>
        </ol>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="space-y-2 text-surface-700">
          <li className="flex gap-3">
            <span className="text-green-600">✓</span>
            <span>
              <strong>Server Information</strong> - ID, transport, creation date, created by
            </span>
          </li>
          <li className="flex gap-3">
            <span className="text-green-600">✓</span>
            <span>
              <strong>Configuration Details</strong> - Configured integrations and evidence types
              (for auditors)
            </span>
          </li>
          <li className="flex gap-3">
            <span className="text-green-600">✓</span>
            <span>
              <strong>Credential Status</strong> - Which providers have credentials configured
            </span>
          </li>
          <li className="flex gap-3">
            <span className="text-green-600">✓</span>
            <span>
              <strong>Available Tools</strong> - Tools exposed by the server when connected
            </span>
          </li>
        </ul>
      </section>
    ...
    <article className="prose prose-invert max-w-none">
      <section className="mb-8">
        ...
        <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4 mt-4">
          <h4 className="font-semibold text-green-700 mb-2">Security Highlights</h4>
          <ul className="text-green-600 space-y-1 text-sm list-disc list-inside">
      ...
      <section className="mb-8">
        ...
        <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4 mt-4">
          <p className="text-red-600 text-sm">
            <strong>⚠️ Critical:</strong> Never use the default encryption key in production.
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
            <h4 className="font-semibold text-yellow-700 mb-2">🟡 Important</h4>
