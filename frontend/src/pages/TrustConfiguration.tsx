...
const DEFAULT_SECTIONS: TrustSection[] = [
  { id: 'compliance', name: 'Compliance', description: 'Framework attestations and certifications.', enabled: true },
  { id: 'policies', name: 'Policies', description: 'Published security and privacy policies.', enabled: true },
  { id: 'documents', name: 'Documents', description: 'Audit reports, SOC 2, ISO 27001 letters.', enabled: true },
  { id: 'subprocessors', name: 'Subprocessors', description: 'List of subprocessors and data flows.', enabled: false },
  { id: 'security', name: 'Security', description: 'Overview of security program and controls.', enabled: true },
];
