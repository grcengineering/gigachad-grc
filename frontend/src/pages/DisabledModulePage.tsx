...
const MODULE_META: Record<string, ModuleMeta> = {
  risks: {
    ...
    body: "The Risk Management module isn't enabled for your workspace. Once turned on, you'll be able to register risks, assess likelihood and impact, and track treatment across the organization.",
    capabilities: [
  ...
  vendors: {
    ...
    body: "The Vendor Risk module isn't enabled for your workspace. Once turned on, you'll be able to onboard, tier, and continuously monitor your third-party vendors.",
    capabilities: [
  ...
  audits: {
    ...
    body: "The Audit Management module isn't enabled for your workspace. Once turned on, you'll be able to plan engagements, collect evidence, and manage findings end-to-end.",
    capabilities: [
  ...
  policies: {
    ...
    body: "The Policy Management module isn't enabled for your workspace. Once turned on, you'll be able to author, version, and attest to policies.",
    capabilities: [
  ...
  bcdr: {
    ...
    body: "The Business Continuity & DR module isn't enabled for your workspace. Once turned on, you'll be able to plan, test, and respond to incidents.",
    capabilities: [
...
const DEFAULT_META: ModuleMeta = {
  label: 'this module',
  body: "This module isn't enabled for your workspace. Reach out to your administrator to learn more about turning it on.",
  capabilities: [
...
function metaFor(slug: string | null): { meta: ModuleMeta; heading: string } {
  ...
  const heading =
    meta === DEFAULT_META ? `The ${slug} module isn't enabled` : `${meta.label} isn't enabled`;
  return { meta, heading };
}
    ...
    <div className="space-y-5 animate-fade-in max-w-2xl mx-auto">
      ...
      <Card>
        <CardBody density="comfy" className="space-y-3">
          <h2 className="text-h2 text-surface-900">What you&apos;d get with {meta.label}</h2>
