  ...
  riskTiers: [
    {
      id: 'critical',
      name: 'Critical',
      description: 'Highest risk vendors. Require executive review and continuous monitoring.',
      scoreMin: 80,
      scoreMax: 100,
      color: 'red',
    },
    {
      id: 'high',
      name: 'High',
      description: 'Significant risk. Require annual review and remediation tracking.',
      scoreMin: 60,
      scoreMax: 79,
      color: 'amber',
    },
    {
      id: 'medium',
      name: 'Medium',
      description: 'Moderate risk. Standard assessment cadence applies.',
      scoreMin: 30,
      scoreMax: 59,
      color: 'blue',
    },
    {
      id: 'low',
      name: 'Low',
      description: 'Minimal risk. Lightweight assessment.',
      scoreMin: 0,
      scoreMax: 29,
      color: 'emerald',
    },
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <Input
                    ...
                    type="number"
                    value={tier.scoreMin}
                    onChange={(e) => onChange(tier.id, { scoreMin: Number(e.target.value) || 0 })}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    type="number"
                    value={tier.scoreMax}
                    onChange={(e) => onChange(tier.id, { scoreMax: Number(e.target.value) || 0 })}
                  />
                </div>
              </div>
            </div>
    ...
    <Card density="comfy">
      <CardHeader className="px-0 pt-0">
        <div>
          ...
          <CardDescription>Templates available when launching a vendor assessment.</CardDescription>
        </div>
      </CardHeader>
      <CardBody density="cozy" className="px-0 pb-0">
        {templates.length === 0 ? (
