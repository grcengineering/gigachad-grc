  ...
  const options = [
    {
      value: 'qualitative',
      label: 'Qualitative',
      description: 'Likelihood × Impact matrix (standard 5×5)',
    },
    {
      value: 'quantitative',
      label: 'Quantitative',
      description: 'Annual Loss Expectancy (ALE) calculation',
    },
            ...
            <thead>
              <tr>
                ...
                {config.impactScale.map((i) => (
                  <th key={i.value} className="p-2 text-center text-surface-600">
                    {i.label}
                  </th>
                ))}
              </tr>
                ...
                <tr key={likelihood.value}>
                  ...
                  {config.impactScale.map((impact) => {
                    ...
                    return (
                      <td
                        key={impact.value}
                        className={`p-2 text-center ${color} text-surface-900`}
                      >
                        {score}
                      </td>
                    );
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        {categories.map((cat) => (
          <div
            key={cat.id}
            className="flex items-center gap-4 p-4 bg-surface-50 border border-surface-200 rounded-lg"
          >
