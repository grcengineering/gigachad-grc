            ...
            {isLoading ? (
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs text-surface-500">
                  Tip: focus a cell and use <kbd className="font-mono">←↑→↓</kbd> to navigate, <kbd className="font-mono">Enter</kbd> to open.
                </p>
              </div>
            )}
          </CardBody>
              ...
              {selectedCell ? (
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-3 text-small">
                    <div>
                      <p className="text-xs text-surface-500 uppercase tracking-wider">Likelihood</p>
