        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-white rounded-lg border border-surface-200">
            ...
            <ul className="text-xs text-surface-600 space-y-1 list-disc list-inside">
              <li><span className="font-medium text-surface-700">reference</span> - Unique identifier (required)</li>
              <li><span className="font-medium text-surface-700">title</span> - Requirement title (required)</li>
              <li><span className="font-medium text-surface-700">description</span> - Detailed description (required)</li>
              <li><span className="font-medium text-surface-700">guidance</span> - Implementation guidance (optional)</li>
              <li><span className="font-medium text-surface-700">isCategory</span> - true/false (optional)</li>
              <li><span className="font-medium text-surface-700">order</span> - Display order number (optional)</li>
              <li><span className="font-medium text-surface-700">level</span> - Hierarchy level 0-3 (optional)</li>
            </ul>
          </div>
    ...
    <div className="card lg:col-span-1 h-fit sticky top-4">
      ...
      <div className="p-4 space-y-4 max-h-[calc(100vh-200px)] overflow-y-auto">
        ...
        <div>
          ...
          <h4 className="text-lg font-medium text-surface-900 mt-2">
            {requirement.title}
          </h4>
        </div>
                ...
                {currentPriority && (
                  <div className="flex items-center gap-2 p-2 bg-surface-100/50 rounded-lg">
                    <FlagIcon className={clsx(
                      'w-4 h-4',
                      currentPriority === 'high' ? 'text-red-600' :
                      currentPriority === 'medium' ? 'text-yellow-700' : 'text-emerald-700'
                    )} />
                    <span className="text-sm text-surface-700 capitalize">{currentPriority} Priority</span>
                  </div>
                )}
