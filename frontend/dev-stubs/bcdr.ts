...
export const bcdrHandlers: StubHandler[] = [
  ...
  },
  {
    method: 'GET',
    path: '/plans/:id',
    body: () => ({ __status: 404, body: { message: 'Plan not found' } }),
  },
  {
    method: 'PUT',
    path: '/plans/:id',
  ...
  { method: 'GET', path: '/incidents/active', body: () => [] },
  {
    ...
    body: () => ({ active_count: 0, resolved_30d: 0, avg_time_to_contain: null, total_ytd: 0 }),
  },
  {
    method: 'POST',
    path: '/incidents',
  ...
  },
  {
    method: 'GET',
    path: '/incidents/:id',
    body: () => ({ __status: 404, body: { message: 'Incident not found' } }),
  },
  {
    method: 'PUT',
    path: '/incidents/:id',
  ...
  { method: 'GET', path: '/tests', body: () => EMPTY_PAGED },
  {
    method: 'GET',
    path: '/tests/stats',
    body: () => ({ upcoming: 0, pass_rate: 0, open_findings: 0, total: 0 }),
  },
  {
    method: 'POST',
    path: '/tests',
  ...
  },
  {
    method: 'GET',
    path: '/tests/:id',
    body: () => ({ __status: 404, body: { message: 'Test not found' } }),
  },
  {
    method: 'PUT',
    path: '/tests/:id',
    body: ({ id }, payload) => ({ id, ...(payload as object) }),
  },
  ...
  { method: 'GET', path: '/runbooks', body: () => EMPTY_PAGED },
  {
    method: 'GET',
    path: '/runbooks/stats',
    body: () => ({ published_count: 0, needs_review_count: 0, total: 0 }),
  },
  {
    method: 'POST',
    path: '/runbooks',
  ...
  },
  {
    method: 'GET',
    path: '/runbooks/:id',
    body: () => ({ __status: 404, body: { message: 'Runbook not found' } }),
  },
  {
    method: 'PUT',
    path: '/runbooks/:id',
  ...
  { method: 'GET', path: '/processes', body: () => EMPTY_PAGED },
  {
    method: 'POST',
    path: '/processes',
    body: (_p, payload) => ({ id: stubId(), ...(payload as object), createdAt: now() }),
  },
  {
    method: 'GET',
    path: '/processes/:id',
    body: () => ({ __status: 404, body: { message: 'Process not found' } }),
  },
  {
    method: 'PUT',
    path: '/processes/:id',
  ...
  {
    method: 'GET',
    path: '/recovery-teams/stats',
    body: () => ({ total: 0, member_total: 0, on_call_count: 0 }),
  },
  {
    method: 'POST',
    path: '/recovery-teams',
  ...
  {
    method: 'GET',
    path: '/recovery-teams/:id',
    body: () => ({ __status: 404, body: { message: 'Recovery team not found' } }),
  },
  {
    method: 'PUT',
    path: '/recovery-teams/:id',
  ...
  },
  {
    ...
    body: () => ({ __status: 404, body: { message: 'Communication plan not found' } }),
  },
  {
    method: 'PUT',
    path: '/communication/:id',
  ...
  {
    method: 'GET',
    path: '/exercise-templates/categories',
    body: () => ['tabletop', 'walkthrough', 'simulation', 'full_interruption'],
  },
  ...
  {
    method: 'GET',
    path: '/exercise-templates/:id',
    body: () => ({ __status: 404, body: { message: 'Exercise template not found' } }),
  },
];
