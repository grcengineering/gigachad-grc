...
export class KnowledgeBaseService {
  ...
  async create(createKnowledgeBaseDto: CreateKnowledgeBaseDto, userId: string) {
    const { linkedControls, linkedEvidence, linkedPolicies, ...createData } = createKnowledgeBaseDto;
  ...
  async update(id: string, updateKnowledgeBaseDto: UpdateKnowledgeBaseDto, userId: string) {
    ...
    const { linkedControls, linkedEvidence, linkedPolicies, ...updateData } = updateKnowledgeBaseDto;
  ...
  async remove(id: string, userId: string) {
    ...
    await this.prisma.knowledgeBaseEntry.delete({
      where: { id },
    });
