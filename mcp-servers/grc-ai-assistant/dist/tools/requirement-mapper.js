...
export async function mapRequirements(params) {
    ...
    if (!aiClient.isConfigured()) {
        return useExplicitDemoFallback('AI service is not configured', () => generateMockMappings(controlId, control, targetFrameworks, confidenceThreshold));
    }
...
Return JSON:
{
  ...
  "suggestedEnhancements": [string]
    ...
    try {
        ...
        return useExplicitDemoFallback(`AI requirement mapping failed: ${error instanceof Error ? error.message : String(error)}`, () => generateMockMappings(controlId, control, targetFrameworks, confidenceThreshold));
    }
}
